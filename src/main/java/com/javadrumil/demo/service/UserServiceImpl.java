...
import com.javadrumil.demo.exceptions.ItemAlreadyExistsException;
import com.javadrumil.demo.exceptions.ResourceNotFoundException;
...
public class UserServiceImpl implements UserService {
	...
	public User createUser(UserModel user) {
		if(userRepository.existsByEmail(user.getEmail())) {
			throw new ItemAlreadyExistsException("This mail already exists"+user.getEmail());
		}
